...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260528235039_F2_25_IntegrationHealth")]
    partial class F2_25_IntegrationHealth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Channel", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "Type", "LastActivityAt");
            ...
            modelBuilder.Entity("Domain.Entities.Integration", b =>
                {
                    ...
                    b.HasIndex("Provider", "RepoFullName")
                        .IsUnique();

                    b.ToTable("integrations", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.IntegrationHealth", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Meeting", b =>
                {
                    ...
                    b.Property<int>("ActiveParticipantCount")
                        .HasColumnType("integer");

                    b.Property<bool>("AgendaFromAi")
                        .HasColumnType("boolean");

                    b.Property<string>("AgendaMd")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RecordingEgressId")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
            ...
            modelBuilder.Entity("Domain.Entities.MeetingActionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("SuggestedOwnerUserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SuggestedOwnerUserId");
            ...
            modelBuilder.Entity("Domain.Entities.MeetingGuestLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("meeting_guest_links", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.MeetingTranscript", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("LastSegmentAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Entities.Message", b =>
                {
                    ...
                    b.HasIndex("ParentMessageId", "CreatedAt")
            ...
            modelBuilder.Entity("Domain.Entities.PokerSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("poker_sessions", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.PokerVote", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.RoadmapShareLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("HideAssignees")
                        .HasColumnType("boolean");

                    b.Property<bool>("HideInternalLabels")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("roadmap_share_links", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.SprintRetrospective", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("AppliedSprintId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("NextSprintDraftJson")
                        .HasColumnType("text");
                    ...
                    b.ToTable("sprint_retrospectives", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Integration", b =>
                {
                    b.HasOne("Domain.Entities.User", "ConnectedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.IntegrationHealth", b =>
                {
                    b.HasOne("Domain.Entities.Integration", "Integration")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.IntegrationHealth", "IntegrationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.MeetingActionItem", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "SuggestedOwner")
                        .WithMany()
                        .HasForeignKey("SuggestedOwnerUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Meeting");

                    b.Navigation("SuggestedOwner");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Message", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.PokerVote", b =>
                {
                    b.HasOne("Domain.Entities.PokerSession", "Session")
                        .WithMany("Votes")
            ...
            modelBuilder.Entity("Domain.Entities.TaskDependency", b =>
                {
                    b.HasOne("Domain.Entities.Task", "DependsOnTask")
                        .WithMany()
